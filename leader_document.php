...
<div class="table-responsive">
        ...
        <center> <h5 class="text-warning"> Pending Requested Documents </h5> </center>
...
$query1=mysqli_query($conn,"select * from document, leader, citizen where leader.leader_id=$citizen_id and  document.leader_id=leader.leader_id and document.citizen_id=citizen.citizen_id ") or die("selecting error");
#while($row=mysqli_fetch_assoc($query1))
  ...
  <a  href="document_reject.php?document_id=<?php echo $row["document_id"];?>"  class="btn btn-danger">Reject</a>
  <a href="document_accept.php?document_id=<?php echo $row["document_id"];?>"  class="btn btn-success">Accept</a>
...
<tr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm table-bordered">
        <center> <h5 class="text-warning"> Provided  Documents </h5> </center>
...
<div style="width:100%" id="rejected" class="modal fade" role="dialog">
  <div style="width:100%" class="modal-dialog">
    ...
    <div style="width:800px" class="modal-content">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm table-bordered">
        <center> <h5 class="text-warning"> All Rejected Document request </h5> </center>
