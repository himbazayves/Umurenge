...
$qry=$conn->query("UPDATE   appointment  SET appointment_status='$status' WHERE appointment_id = $appontment_id ");
...
<div class="alert alert-success" role="alert">
  ...
  <a href="leader_appointments.php" name="no"   class="btn btn-success">NO</a>
